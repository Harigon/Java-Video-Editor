package asg.jcodec.containers.mxf;

import static asg.jcodec.containers.mxf.MXFConst.klMetadataMapping;
import static asg.jcodec.containers.mxf.model.MXFUtil.findAllMeta;
...
import asg.jcodec.common.model.TapeTimecode;
import asg.jcodec.containers.mxf.MXFConst.MXFCodecMapping;
import asg.jcodec.containers.mxf.model.FileDescriptor;
import asg.jcodec.containers.mxf.model.GenericDescriptor;
import asg.jcodec.containers.mxf.model.GenericPictureEssenceDescriptor;
import asg.jcodec.containers.mxf.model.GenericSoundEssenceDescriptor;
import asg.jcodec.containers.mxf.model.IndexSegment;
import asg.jcodec.containers.mxf.model.KLV;
import asg.jcodec.containers.mxf.model.MXFMetadata;
import asg.jcodec.containers.mxf.model.MXFPartition;
import asg.jcodec.containers.mxf.model.MXFUtil;
import asg.jcodec.containers.mxf.model.TimecodeComponent;
import asg.jcodec.containers.mxf.model.TimelineTrack;
import asg.jcodec.containers.mxf.model.UL;
import asg.jcodec.containers.mxf.model.WaveAudioDescriptor;
...
public class MXFDemuxer {
    ...
    public class MXFDemuxerTrack implements DemuxerTrack {
        ...
        public boolean gotoFrame(long frameNo) {
            ...
            for (indexSegmentIdx = 0; indexSegmentIdx < indexSegments.size() && indexSegmentSubIdx >= indexSegments.get(indexSegmentIdx).getIndexDuration(); indexSegmentIdx++) {
                indexSegmentSubIdx -= indexSegments.get(indexSegmentIdx).getIndexDuration();
            }
            indexSegmentSubIdx = Math.min(indexSegmentSubIdx, (int) indexSegments.get(indexSegmentIdx).getIndexDuration());
