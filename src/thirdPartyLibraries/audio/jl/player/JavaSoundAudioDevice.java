...
public class JavaSoundAudioDevice extends AudioDeviceBase
{
	...
	protected AudioFormat getAudioFormat()
	{
		...
		{
			//
			//System.out.println("decoder: "+decoder.getOutputFrequency()+", "+decoder.getOutputChannels());
			
			if(getConstructionStream()){
				
				//ConstructionMusic.frequency = 44100;
				
				//System.out.println("ConstructionMusic.frequency: "+ConstructionMusic.frequency+" channels: "+ConstructionMusic.channels);
				
				//fmt = new AudioFormat(ConstructionMusic.frequency, 16, ConstructionMusic.channels, true, false);
	...
	protected void createSource() throws JavaLayerException
    {
        ...
        try
        {
        	...
        	//System.out.println("info: "+getSourceLineInfo());
            ...
            if (line instanceof SourceDataLine)
            {
               ...
               // source.open(fmt, millisecondsToBytes(fmt, 2000));
                ...
                if (source.isControlSupported(FloatControl.Type.MASTER_GAIN))
                {
					...
					//if(this.decreasedVolume == 0){
						//c.setValue(c.getMaximum());
					//} else {
						//float volume = c.getMaximum()-this.decreasedVolume;
						//c.setValue(volume);
