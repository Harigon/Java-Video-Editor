 ...
 *----------------------------------------------------------------------
 */
package src.thirdPartyLibraries.mp3transform.main.org.mp3transform.wav;
...
import src.thirdPartyLibraries.mp3transform.main.org.mp3transform.Bitstream;
import src.thirdPartyLibraries.mp3transform.main.org.mp3transform.Decoder;
import src.thirdPartyLibraries.mp3transform.main.org.mp3transform.Header;
...
public class WavConverter extends Decoder {
    ...
    public void initOutputBuffer(int numberOfChannels, int freq, String fileName)
        ...
        outWave = new WaveFileWriter(fileName, freq, (short) 16, (short) numberOfChannels);
    }
